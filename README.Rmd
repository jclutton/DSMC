...
The consort diagrams in this project only support two group interventions. Only the CTCAE 5.0 classification is supported for adverse event reporting. You will need an API token to your REDCap project.
...
4.  Get the API and and REDCap uri for your project. This will be a different process for every institution, so please follow your institution's guidelines.

5.  Download [R](https://www.r-project.org/) and [RStudio](https://posit.co/download/rstudio-desktop/)

6.  Open the DSMC.Rproj file in the DSMC folder. This will open a workspace.
